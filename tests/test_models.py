...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_a_product(self):
        ...
        self.assertEqual(products[0].description, "testing") # Exercise 2.2: Create Test Cases for the Model; Test Case to Update a Product
    ...
    def test_delete_a_product(self):
        ...
        product.delete()
        self.assertEqual(len(Product.all()), 0) # Exercise 2.3: Create Test Cases for the Model; Test Case to Delete a Product
    ...
    def test_find_by_category(self):
        ...
        self.assertEqual(found.count(), count)
        for product in found:
            self.assertEqual(product.category, category) # Exercise 2.7: Create Test Cases for the Model; Test Case to Find a Product by Category